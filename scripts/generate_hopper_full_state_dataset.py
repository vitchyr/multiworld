...
positions_path = get_asset_full_path('classic_mujoco/hopper_goal_qpos_-10to10_x.npy')
np.save(positions_path, positions)

velocities = np.array(velocities)
velocities_path = get_asset_full_path('classic_mujoco/hopper_goal_qvel_-10to10_x.npy')
