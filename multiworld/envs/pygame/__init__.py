...
def register_soroush_u_wall_envs():
    ...
    register(
        id='PointmassUWallTrainEnvBig5-v1',
        entry_point='multiworld.envs.pygame.point2d:Point2DWallEnv',
        tags={
    ...
    register(
        id='PointmassUWallTrainEnvBig10-v1',
        entry_point='multiworld.envs.pygame.point2d:Point2DWallEnv',
        tags={
            'git-commit-hash': '923907a',
            'author': 'Soroush'
    ...
    register(
        id='PointmassUWallTrainEnvBig25-v1',
        entry_point='multiworld.envs.pygame.point2d:Point2DWallEnv',
        tags={
            'git-commit-hash': '923907a',
            'author': 'Soroush'
    ...
    register(
        id='PointmassUWallTrainEnvBig50-v1',
        entry_point='multiworld.envs.pygame.point2d:Point2DWallEnv',
        tags={
            'git-commit-hash': '923907a',
            'author': 'Soroush'
    ...
    register(
        id='PointmassUWallTestEnvBig5-v1',
        entry_point='multiworld.envs.pygame.point2d:Point2DWallEnv',
        tags={
            'git-commit-hash': '923907a',
            'author': 'Soroush'
    ...
    register(
        id='PointmassUWallTestEnvBig10-v1',
        entry_point='multiworld.envs.pygame.point2d:Point2DWallEnv',
        tags={
            'git-commit-hash': '923907a',
            'author': 'Soroush'
    ...
    register(
        id='PointmassUWallTestEnvBig25-v1',
        entry_point='multiworld.envs.pygame.point2d:Point2DWallEnv',
        tags={
            'git-commit-hash': '923907a',
            'author': 'Soroush'
    ...
    register(
        id='PointmassUWallTestEnvBigVis-v1',
        entry_point='multiworld.envs.pygame.point2d:Point2DWallEnv',
        tags={
            'git-commit-hash': 'e5c11ac',
            'author': 'Soroush'
        ...
        kwargs={
            ...
            'norm_order': 2,
            'reward_type': 'dense',
            'goal_low': (-3.51315992, 3.70410743),
            'goal_high': (-3.51315992, 3.70410743),
            'ball_low': (0.03928856, -.55376619),
            'ball_high': (0.03928856, -.55376619),
        }
    )
    ...
    register(
        id='Image48PointmassUWallTestEnvBigVis-v1',
        entry_point=create_image_48_pointmass_uwall_test_env_big_vis_v1,
        tags={
            'git-commit-hash': 'e5c11ac',
            'author': 'Soroush'
        },
...
def create_image_48_pointmass_uwall_test_env_big_vis_v1():
    from multiworld.core.image_env import ImageEnv

    wrapped_env = gym.make('PointmassUWallTestEnvBigVis-v1')
    return ImageEnv(
        wrapped_env,
        48,
        init_camera=None,
