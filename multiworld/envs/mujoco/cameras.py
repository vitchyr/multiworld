...
def ant_camera_v0(camera):
    camera.trackbodyid = 0
    camera.lookat[0] = 0.0
    camera.lookat[1] = 0.0
    camera.lookat[2] = 0.5
    camera.distance = 13.0 #6.5
    camera.elevation = -60

def ant_camera_v1(camera):
    camera.trackbodyid = 0
    camera.lookat[0] = 0.0
    camera.lookat[1] = -1.0
    camera.lookat[2] = 0.5
    camera.distance = 9.0 #6.5
    camera.elevation = -70

def ant_camera_v2(camera):
    camera.trackbodyid = 0
    camera.lookat[0] = 0.0
    camera.lookat[1] = -1.0
    camera.lookat[2] = 0.5
...
def ant_u_med_camera(camera):
    camera.trackbodyid = 0
    camera.lookat[0] = 0.0
    camera.lookat[1] = -1.0
    camera.lookat[2] = 0.5
    camera.distance = 12.0 #6.5
    camera.elevation = -70

def ant_u_big_camera(camera):
    camera.trackbodyid = 0
    camera.lookat[0] = 0.0
    camera.lookat[1] = -1.0
    camera.lookat[2] = 0.5
...
def ant_fb_small_camera(camera):
    ...
    camera.lookat[1] = -1.0
    camera.lookat[2] = 0.5
    camera.distance = 14.0 #6.5
    camera.elevation = -70

def ant_fb_med_camera(camera):
    camera.trackbodyid = 0
    camera.lookat[0] = 0.0
    camera.lookat[1] = -1.0
    camera.lookat[2] = 0.5
    camera.distance = 16.0 #6.5
    camera.elevation = -70

def ant_fb_big_camera(camera):
    camera.trackbodyid = 0
    camera.lookat[0] = 0.0
    camera.lookat[1] = -1.0
    camera.lookat[2] = 0.5
...
def ant_fork_med_camera(camera):
    camera.trackbodyid = 0
    camera.lookat[0] = 0.0
    camera.lookat[1] = -1.0
    camera.lookat[2] = 0.5
...
def ant_fork_big_camera(camera):
    camera.trackbodyid = 0
    camera.lookat[0] = 0.0
    camera.lookat[1] = -1.0
    camera.lookat[2] = 0.5
    camera.distance = 18.0 #6.5
    camera.elevation = -70
...
def sawyer_pusher_camera_tdm_v2(camera):
    camera.distance = .30
    camera.lookat[0] = 0
    camera.lookat[1] = 0.85
    camera.lookat[2] = 0.30
...
def sawyer_pusher_camera_tdm_v4(camera):
    camera.distance = .26
    camera.lookat[0] = 0
    camera.lookat[1] = 0.88
    camera.lookat[2] = 0.30
    camera.elevation = -55
    camera.azimuth = 270
    camera.trackbodyid = -1
