...
class SawyerPushAndReachXYEnvMulti(MujocoEnv, Serializable, MultitaskEnv):
    ...
    def __init__(
            ...
            filename='sawyer_multi_pusher.xml',
            mode_rel=np.array([True, True, True, True, False]),
            num_objects=1, object_mass=1, friction=1.0, finger_sensors=False,
...
class SawyerPushAndReachXYEasyEnv(SawyerPushAndReachXYEnvMulti):
    """
...
class SawyerPushAndReachXYHarderEnv(SawyerPushAndReachXYEnvMulti):
    """
...
if __name__ == '__main__':
    env = SawyerPushAndReachXYEnvMulti()
    for i in range(1000):
        env.render()